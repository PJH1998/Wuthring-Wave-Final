...
CVIBuffer_Decal* CVIBuffer_Decal::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
	CVIBuffer_Decal* pInstance = new CVIBuffer_Decal(pDevice, pContext);
	if (FAILED(pInstance->Initialize()))
	{
		MSG_BOX("Failed to Created : CVIBuffer_Decal");
