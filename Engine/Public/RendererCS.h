...
class CRendererCS final : public CBase
{
public:
...
private:
	...
	typedef pair<_string, ID3D11UnorderedAccessView*> UAV_DATA;
...
public:
	...
	ID3D11ShaderResourceView*		Get_SRV() { return m_pComputeSRV; }
...
private:
	...
	ID3D11ShaderResourceView*		m_pComputeSRV = { nullptr };
