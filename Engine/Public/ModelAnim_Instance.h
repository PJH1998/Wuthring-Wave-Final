...
private:
	...
	vector<_float4x4>					m_InstanceMatrices;
...
public:
	static		CModelAnim_Instance*				Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, MODELTYPE eType, _fmatrix PreTransformMatrix, const _char* pFilePath);
