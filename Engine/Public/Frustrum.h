...
public:
	...
	_bool				IsIn_WorldSpace(_fvector vWorldPosition, _float fRange);						// Volume 으로 변경?
	_bool				IsIn_LocalSpace(_fmatrix WorldMatrix, _fvector vLocalPosition, _float fRange);	// Volume 으로 변경?
