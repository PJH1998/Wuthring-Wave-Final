...
namespace Engine
{
	...
	enum class RENDERGROUP { PRIORITY, SHADOW, OUTLINE, NONBLEND, STATIC, DYNAMIC, NONLIGHT, EMISSIVE, EFFECT, BLEND, DISTORTION, UI, FADE,
	#ifdef _DEBUG  
	RD_DEBUG, 
	#endif  
	END };
	...
	enum class SHADER_DEFFERED { DRAW, RD_DEBUG_CSM, RD_DEBUG_SHAODW_MAP, COMBINED, DIRECTIONAL, POINT, BLOOM, DISTORTION, LUT, FOG, SSAO, DOF, DOF_DEPTH, BLUR, VELOCITY_MAP, MOTION_BLUR};

	enum class SFX_TYPE { BLUR, DOF, RADIAL, MOTION, END};
