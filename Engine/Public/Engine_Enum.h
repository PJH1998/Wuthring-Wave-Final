...
namespace Engine
{
	...
	enum class RENDERGROUP { PRIORITY, SHADOW, OUTLINE, NONBLEND, STATIC, NONSTATIC, DYNAMIC, NONLIGHT, EMISSIVE, EFFECT, SFX, BLEND, DISTORTION, POST_SFX, UI, FADE,
	#ifdef _DEBUG  
	RD_DEBUG, 
	#endif  
	END };
	...
	enum class SHADER_DEFFERED { DRAW, RD_DEBUG_CSM, RD_DEBUG_SHAODW_MAP, COMBINED, DIRECTIONAL, POINT, BLOOM, DISTORTION, LUT, FOG, SSAO, DOF, DOF_DEPTH, BLUR, VELOCITY_MAP, MOTION_BLUR, SSR, WEIGHTBLEND};

	enum class SFX_TYPE { SSAO, BLOOM, BLUR, DOF, RADIAL, MOTION, SSS, SSR, END};
