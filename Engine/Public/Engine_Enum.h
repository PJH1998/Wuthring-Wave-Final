...
namespace Engine
{
	...
	enum class SHADER_DEFFERED { DRAW, RD_DEBUG_CSM, RD_DEBUG_SHAODW_MAP, COMBINED, DIRECTIONAL, POINT, BLOOM, DISTORTION, LUT, FOG, SSAO, DOF, DOF_DEPTH, BLUR, VELOCITY_MAP, MOTION_BLUR, WATER};
