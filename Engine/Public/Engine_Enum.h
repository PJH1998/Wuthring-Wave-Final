...
namespace Engine
{
	...
	enum class RENDERGROUP { PRIORITY, SHADOW, OUTLINE_NONDEPTH, OUTLINE, NONBLEND, STATIC, NONSTATIC, DYNAMIC, WATER, NONLIGHT, EMISSIVE, EFFECT, SFX, BLEND, DISTORTION, POST_SFX, UI, UI_POST, FADE,
	#ifdef _DEBUG  
	RD_DEBUG, 
	#endif  
	END };
