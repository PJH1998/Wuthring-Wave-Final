...
namespace Engine
{
	...
	enum class SHADER_DEFFERED { RD_DEBUG, RD_DEBUG_CSM, COMBINED, DIRECTIONAL, POINT, GAUSSIAN_BLUR_X, GAUSSIAN_BLUR_Y, SSAO_BLUR_X, SSAO_BLUR_Y, BLUR_RETURN, BLUR_ADD, DISTORTION, LUT, SSAO};
	// BroadPhase Layer
