...
class CPlayerController final : public CGameObject
{
public:
	enum PLAYERTYPE
	{
...
public:
	explicit CPlayerController(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	explicit CPlayerController(const CPlayerController& Prototype);
