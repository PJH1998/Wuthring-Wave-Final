...
NS_BEGIN(Client)
class CRoverRopeDrag final : public CInteractionState
{
private:
	enum ROPESTATE
	{
...
private:
	explicit CRoverRopeDrag() = default;
	virtual ~CRoverRopeDrag() = default;
...
public:
	static CRoverRopeDrag* Create(class CGameObject* pOwner);
