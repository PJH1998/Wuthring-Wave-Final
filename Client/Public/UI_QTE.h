...
private:
	void			Update_QTE(_float fTimeDelta);
...
private:
	...
	CAnimator_UI*	m_pAnim_UI_SectorA_FG		= nullptr;
...
private:
	const _float	m_fQTEDropRate		= 0.25f;	// 초당 떨어지는 정도.
	const _float	m_fQTEFillAmount	= 0.1f;		// 조작 1회 당 차는 정도
	const _float	m_fQTEMaxTime		= 3.f;		// QTE 제한시간.
