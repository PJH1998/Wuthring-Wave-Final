...
public:
	virtual HRESULT Initialize_Prototype(const FXRECT_DESC* pDesc);
...
public:
	static CEffect_Rect* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, const FXRECT_DESC* pDesc);
