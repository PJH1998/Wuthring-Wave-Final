...
// 1 -> 2 -> 3 -> 1 -> 2 -> 3
class CRoverGroundSpecial final : public CGroundState
{
private:
    enum SPEICALSTATE
    {
...
private:
    explicit CRoverGroundSpecial() = default;
    virtual ~CRoverGroundSpecial() = default;
...
public:
    static CRoverGroundSpecial* Create(class CGameObject* pOwner);
