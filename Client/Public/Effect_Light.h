...
public:
	virtual HRESULT Initialize_Prototype(const LIGHT_DESC* pDesc);
...
public:
	static CEffect_Light* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, const LIGHT_DESC* pDesc);
