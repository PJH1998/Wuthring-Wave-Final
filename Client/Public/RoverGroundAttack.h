...
// Rover Attack State - Attack01~04, Attack_*, SpAttack* 처리
class CRoverGroundAttack final : public CGroundState
{
private:
...
private:
    explicit CRoverGroundAttack() = default;
    virtual ~CRoverGroundAttack() = default;
...
public:
    static CRoverGroundAttack* Create(class CGameObject* pOwner);
