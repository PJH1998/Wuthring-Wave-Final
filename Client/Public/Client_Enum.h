...
namespace Client
{
	...
	enum class COLLISIONLAYER { NONE, MAP, QTE, PLAYER, ATTACK, SKILL, KNOCKBACK, ENEMY, ENEMY_ATTACK, ENEMY_HARDATTACK, ENEMY_SKILL, INTERACTION, GRAPPLE, DETECT, PARRY, GRAB, NPC, ALTER, SEQUENCE, END };
	...
	enum class SHADER_PROPANIMMESH {
		...
		, AUGUSTA_BURSTWEAPON_EFFECT // 10
		, AUGUSTA_BURSTWEAPON // 11
		, YUNO_WEAPON // 12
		, END
	};
