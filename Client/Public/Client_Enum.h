...
namespace Client
{
	...
	enum class SHADER_ANIMMESH { DEFAULT_NORMAL = 0, NORMAL_TEX, AUGUSTA, SHADOW, OUNTLINE, ROVER, GALBRENA, NORMAL_YELLOW, LOGOROVER, DISSOLVE_NORMAL, NPC_FACE, NORMAL_N_COLOR, CHARACTER_COLOR, ENEMY_BEHIT, BOSS_BEHIT, BOSS_OUTLINE, LOGO_ROVERMASK, END };
	...
	enum class SHADER_ANIMMESH_CHARACTER { 
		...
		, GALBRENABACK, DISSOLVE_CHARACTER, GALBRENAEYE, ROVERMASK, NONMORPH_CHARACTER, LEVIATAN_BEHIT, LEVI_FX, UNDISSOLVE_CHARACTER, END };
