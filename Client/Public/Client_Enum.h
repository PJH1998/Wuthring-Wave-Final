...
namespace Client
{
	...
	enum class COLLISIONLAYER { NONE, MAP, QTE, PLAYER, ATTACK, SKILL, KNOCKBACK, ENEMY, ENEMY_ATTACK, ENEMY_HARDATTACK, ENEMY_SKILL, INTERACTION, GRAPPLE, GRAB, DETECT, PARRY, NPC, END };

	enum class SKILLBTN { LBTN, T, E, R, END };
	enum class SKILLICONID { DEFAULT, ZANNI, KAMOLA, LUPA, END };
	enum class OBJECTTYPE { DEFAULT, SONORA, INTERACTION, SPAWNOR, DESTRUCTION, NONRIGID, TRIGGERBOX, NONSONORA, NONSONORA_FLOOR, WATER, ROPE_ANCHOR, ROPE_PULL, END };
	...
	enum class SHADER_MESH {
		DEFAULTPASS = 0,
		ALPHANOTDISCARD = 1,
		ALPHANOTDISCARDNONCULL = 2,
		END
	};
