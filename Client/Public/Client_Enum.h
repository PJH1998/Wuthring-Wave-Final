...
namespace Client
{
	...
	enum class CHANNEL { BGM, BATTLE_BGM, PLAYER_ACTION, PLAYER_VOICE, ENEMY_ACTION, ENEMY_VOICE, ENEMY_FOOTSTEP, ENEMY_SFX, EFFECT, ENEMY_HIT, UI_INTERACT, UI_HOVER, END };
