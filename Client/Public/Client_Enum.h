...
namespace Client
{
	...
	enum class CHANNEL { BGM, BATTLE_BGM, PLAYER_ACTION, PLAYER_VOICE, PLAYER_QTE, PLAYER_UI, ENEMY_ACTION, ENEMY_VOICE, ENEMY_FOOTSTEP, ENEMY_SFX, EFFECT, ENEMY_HIT, UI_INTERACT, UI_HOVER, END };
	...
	enum class OBJECTTYPE { DEFAULT, SONORA, INTERACTION, SPAWNOR, DESTRUCTION, NONRIGID, TRIGGERBOX, NONSONORA, NONSONORA_FLOOR, METEO, WATER, COLLAPS, THROW, BURN, DOME, TURN, ROPE_ANCHOR, ROPE_PULL, ROPE_UI, END };
	enum class INSTANCETYPE { DEFAULT, SONORO, NONSONORO, END };
	enum BOSSBGM { ASPHODEL, SOERVERIGN, HEAVEN_INTRO, HEAVEN_ONE, HEAVEN_CHNAGE, HEAVEN_TWO, MODINARY, END };
	...
	enum class SHADER_MONSTERPROP { DEFAULTPASS = 0, SHUI = 1, SHADOW = 2, END };
	enum class SHADER_ANIMMESH { DEFAULT_NORMAL = 0, NORMAL_TEX, AUGUSTA, SHADOW, OUNTLINE, ROVER, GALBRENA, NORMAL_YELLOW, LOGOROVER, DISSOLVE_NORMAL, NPC_FACE, NORMAL_N_COLOR, 
		CHARACTER_COLOR, ENEMY_BEHIT, BOSS_BEHIT, BOSS_OUTLINE, LOGO_ROVERMASK, GGOBUL, NAPAL, NPC_SCAN, NPC_SCAN_FACE, NPC_FIND, NPC_FIND_FACE, MONSTER_SPAWN, MONSTER_DEAD, CORO, END };
	...
	enum class SHADER_ANIMMESH_CHARACTER { 
		...
		, GALBRENABACK, DISSOLVE_CHARACTER, GALBRENAEYE, ROVERMASK, NONMORPH_CHARACTER, LEVIATAN_BEHIT, LEVI_FX, UNDISSOLVE_CHARACTER, CHARACTER_EYE, BOSS_OUTLINE, END };
	...
	enum class SHADER_ANIMINST { DEFAULT_NORMAL = 0, NORMAL_TEX, AUGUSTA, SHADOW, OUNTLINE, FACE, SHADOW_FACE, END };

	enum class SHADER_SFX_BURST { AUGUSTA_SLASH, RADIAL_BLUR, GALBRENA_CIRCLE, GALBRENA_BLUR, EXCUTE};
