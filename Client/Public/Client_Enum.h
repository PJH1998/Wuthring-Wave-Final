...
namespace Client
{
	...
	enum class SHADER_ANIMMESH { DEFAULT_NORMAL = 0, NORMAL_TEX, AUGUSTA, SHADOW, OUNTLINE, ROVER, GALBRENA, NORMAL_YELLOW, LOGOROVER, DISSOLVE_NORMAL, NPC_FACE, NORMAL_N_COLOR, 
		CHARACTER_COLOR, ENEMY_BEHIT, BOSS_BEHIT, BOSS_OUTLINE, LOGO_ROVERMASK, GGOBUL, NAPAL, NPC_SCAN, NPC_SCAN_FACE, NPC_FIND, NPC_FIND_FACE, MONSTER_SPAWN, MONSTER_DEAD, END };
