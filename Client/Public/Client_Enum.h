...
namespace Client
{
	...
	enum class CHANNEL { BGM, PLAYER_ACTION, PLAYER_VOICE, ENEMY_ACTION, ENEMY_VOICE, EFFECT, ENEMY_HIT, UI_INTERACT, UI_HOVER, END };
	enum class COLLISIONLAYER { NONE, MAP, QTE, PLAYER, ATTACK, SKILL, KNOCKBACK, ENEMY, ENEMY_ATTACK, ENEMY_HARDATTACK, ENEMY_SKILL, INTERACTION, GRAPPLE, DETECT, PARRY, GRAB, NPC, ALTER, SEQUENCE, SLIDE, INTERACT_THROW, THROW, BURN, END };

	enum class SKILLBTN { LBTN, T, E, R, END };
	enum class SKILLICONID { DEFAULT, ZANNI, KAMOLA, LUPA, END };
	enum class OBJECTTYPE { DEFAULT, SONORA, INTERACTION, SPAWNOR, DESTRUCTION, NONRIGID, TRIGGERBOX, NONSONORA, NONSONORA_FLOOR, METEO, WATER, COLLAPS, THROW, BURN, DOME, TURN, ROPE_ANCHOR, ROPE_PULL, END };
	...
	enum class SHADER_ANIMMESH { DEFAULT_NORMAL = 0, NORMAL_TEX, AUGUSTA, SHADOW, OUNTLINE, ROVER, GALBRENA, NORMAL_YELLOW, LOGOROVER, DISSOLVE_NORMAL, NPC_FACE, NORMAL_N_COLOR, CHARACTER_COLOR, ENEMY_BEHIT, BOSS_BEHIT, BOSS_OUTLINE, END };
	...
	enum class SHADER_ANIMMESH_CHARACTER { 
		...
		, GALBRENABACK, DISSOLVE_CHARACTER, GALBRENAEYE, ROVERMASK, NONMORPH_CHARACTER, LEVIATAN_BEHIT, END };
