...
public:
	virtual HRESULT Initialize_Prototype(const DECAL_DESC* pDesc);
...
public:
	static CEffect_Decal* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext, const DECAL_DESC* pDesc);
