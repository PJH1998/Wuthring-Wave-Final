...
PS_OUT_BACKBUFFER PS_SSAO_BLUR_X(PS_IN In)
{
    ...
    for (int x = -2; x <= 2; ++x)
    {
        ...
        if (fSampleDepth == 0.f || vSampleColor.r == 1.f) // ������ ���� ��Ͼȵ� or Ȥ�� ������ �� ����;
        {
            vColor += vOriginColor;
            fCount += 1.f;
            continue;
        ...
        float fNormalWeight = saturate(dot(vOriginNormal, vSampleNormal)); // �븻 ���� �� 0~1��
     
        if (fDepthDist <= g_fMinDepthDistance)                          // �ּ� �� ���� ( ��� )
        {
            vector vFinalColor = vSampleColor * (1.f + (1.f - fNormalWeight)); // �⺻������ ���� ���� ��ο� �� -> �븻 ����ġ�� ���� �� ��� ����
            vColor += vFinalColor;
            fCount += 1.f;
        }
    }
