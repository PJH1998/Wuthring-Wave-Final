...
CLupaSpear::CLupaSpear(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
    : CProp{ pDevice, pContext }
{
}

CLupaSpear::CLupaSpear(const CPartObject& Prototype)
    : CProp(Prototype )
{
}

HRESULT CLupaSpear::Initialize_Prototype()
{
...
HRESULT CLupaSpear::Initialize_Clone(void* pArg)
{
...
void CLupaSpear::Priority_Update(_float fTimeDelta)
{
...
void CLupaSpear::Update(_float fTimeDelta)
{
...
void CLupaSpear::Late_Update(_float fTimeDelta)
{
...
void CLupaSpear::Activate(_bool IsActivate)
{
...
void CLupaSpear::Change_Volume(_uint iVolumeIdx)
{
...
void CLupaSpear::Change_VolumeLayer(_uint iVolumeIdx, COLLISIONLAYER eLayer)
{
	if (m_AttackVolumes[iVolumeIdx] != nullptr)
		m_AttackVolumes[iVolumeIdx]->Change_Layer(eLayer);
}

void CLupaSpear::OnHitEnter(_uint iLayer, void* pOther, const ContactManifold& Manifold)
{
}



void CLupaSpear::Ready_Components(const PROP_DESC* pDesc)
{
    // 1. Components
...
void CLupaSpear::Ready_Variables(const PROP_DESC* pDesc)
{
...
void CLupaSpear::Ready_Positions(const PROP_DESC* pDesc)
{
...
void CLupaSpear::Ready_AttackVolumes()
{
	// size 설정
...
void CLupaSpear::Bind_Resources()
{
...
CLupaSpear* CLupaSpear::Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext)
{
    CLupaSpear* pInstance = new CLupaSpear(pDevice, pContext);
    if (FAILED(pInstance->Initialize_Prototype()))
    {
        Safe_Release(pInstance);
        MSG_BOX("Create Failed CLupaSpear");
    }
    return pInstance;
}

CGameObject* CLupaSpear::Clone(void* pArg)
{
    CLupaSpear* pInstance = new CLupaSpear(*this);
    if (FAILED(pInstance->Initialize_Clone(pArg)))
    {
        Safe_Release(pInstance);
        MSG_BOX("Clone Failed CLupaSpear");
    }
    return pInstance;
}

void CLupaSpear::Free()
{
    CProp::Free();
}
