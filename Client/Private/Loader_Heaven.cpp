...
HRESULT CLoader_Heaven::Load_Model()
{
	...
	m_pGameSystem->Ready_Prototype_Map("../Bin/Resource/Map/MapData/Heaven_1212_first/", m_eCurLevel, "Heaven");
	...
	PreTransformMatrix = XMMatrixScaling(0.5f, 0.5f, 0.5f) * XMMatrixRotationRollPitchYaw(XMConvertToRadians(15.f), XMConvertToRadians(90.f), 0.f);
