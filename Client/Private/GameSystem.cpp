...
void CGameSystem::Render_Damage(_float4 vTargetPos, _int iDamage, _uint iDmgElemType, _float fSpawnRange)
{
	m_pUI_FontPreset->Render_Damage(vTargetPos, iDamage, iDmgElemType, fSpawnRange);
}
