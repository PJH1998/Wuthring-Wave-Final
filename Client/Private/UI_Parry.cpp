...
HRESULT CUI_Parry::Initialize_Clone(void* pArg)
{
	...
	CCustom_UI* pSectorACircEff	= Find_ChildObject(L"SectorA_ParryCircEff");
	...
	CAnimator_UI* pAnim_SectorACircEff	= static_cast<CAnimator_UI*>(pSectorACircEff->Get_Component(L"Com_Animator_UI"));
...
void CUI_Parry::Update(_float fTimeDelta)
{
	...
	Update_ApplyTargetPos(pSectorACircEff, vTargetPos);	// 해당 UI를 타겟 위치로 이동시킴.
...
void CUI_Parry::Late_Update(_float fTimeDelta)
{
	...
	Update_CamDistScale(pSectorACircEff, 40.f);
...
void CUI_Parry::Enable_Parried()
{
	...
	CAnimator_UI* pAnim_pSectorAMain	= static_cast<CAnimator_UI*>(pSectorAMain->Get_Component(L"Com_Animator_UI"));
	CAnimator_UI* pAnim_pSectorAEff		= static_cast<CAnimator_UI*>(pSectorAEff->Get_Component(L"Com_Animator_UI"));
	CAnimator_UI* pAnim_pSectorACircEff	= static_cast<CAnimator_UI*>(pSectorACircEff->Get_Component(L"Com_Animator_UI"));
