...
HRESULT CMapObject_Sonoro::Initialize_Clone(void* pArg)
{
...
void CMapObject_Sonoro::Priority_Update(_float fTimeDelta)
{
}

void CMapObject_Sonoro::Update(_float fTimeDelta)
{
...
void CMapObject_Sonoro::Render_Shadow()
{
...
BoundingBox* CMapObject_Sonoro::Get_BoundingBox()
{
...
{
	CMapObject_Sonoro* pInstance = new CMapObject_Sonoro(pDevice, pContext);
...
CGameObject* CMapObject_Sonoro::Clone(void* pArg)
{
	CMapObject_Sonoro* pClone = new CMapObject_Sonoro(*this);
