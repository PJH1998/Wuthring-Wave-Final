...
void CEdit_MapObject::Set_ImGuiOption()
{
	...
	const _char* pObejceTType[] = { "Default","Sonoro","InterAction","MonsterSpawn","Destruction","NonRigid" ,"TriggerBox","NonSonoro","Sonoro_Floor" ,"Meteo","Water","Collaps","Throw" ,"Burn" };
