...
TARGET_ACTION_NAMES = [
    ...
    if not act.name.startswith(exclude_prefix)
...
"Bone_Hair006_L", "Bone_Hair006_R", "Bone_Hair007_L", "Bone_Hair007_R", "Bone_Hair008_R", "Bone_Hair009_R",
 "Bone_Piao011_R", "Bone_Piao011_L", "Bone_Piao012_R", "Bone_Skirt001_L", "Bone_Skirt001_R"]
...
def main():
    ...
    total_muted = 0
    for act in actions:
        touched, muted = process_action(act, BONE_NAMES)
