...
public:
	...
	typedef struct tagCustomUIObjectDesc : public CUIObject::UI_DESC, UI_SIZE_DESC, UI_SECTOR_DESC {
		...
		_wstring	strUIName = {};
		_uint		iUIType = {};			// ?‚ë•Îãö Ôß°ÏéåÏî§Ôßû¬Ä, Ë∏∞Íæ™Îìâ?Î™Ñ?, Ôß§ÏíñÍ∏Ω??Êè¥—ãÏÅΩÈÅ∫¬Ä?Î™Ñ? Êè¥—âÌÖá?
		_wstring	strParentName = {};

		_bool		isInverseScreenDiscard = false;	// ±◊∏± ±∏ø™ π›¿¸
		_float		fCutout = 0.3f;					// (1:ƒ∆æ∆øÙ ªÁøÎ Ω√) æÀ∆ƒ∞™ ±‚¡ÿ
...
private:
	...
	// ?Íæ©Ïò± ?—äÏäú‰ª•Î¨íÏî™ ?ÎùøÎí™Áàæ??Î∫£ÎÇ´, texcoord Â™õ? ?ÏÑèÏî§?Î±ÅÍΩ£ Êπ≤Í≥ó????ÍπÜÏìΩ ?Î∫£ÎÇ´.. ?Íæ©ÏäÇ?Ï¢éÎãî???ÎçâÏì¨
