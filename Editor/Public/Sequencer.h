...
public:
	...
	void							CustomDraw(_int iIndex, const ImRect& customRect, const ImRect& legendRect, const ImRect& clippingRect, const ImRect& legendClippingRect);
	void							CustomDrawCompact(_int iIndex, const ImRect& customRect, const ImRect& clippingRect);
