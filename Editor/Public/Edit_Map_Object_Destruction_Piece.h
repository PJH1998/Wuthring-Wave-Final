...
NS_BEGIN(Editor)
class CEdit_Map_Object_Destruction_Piece : public CStaticObject
{
public:
...
private:
	CEdit_Map_Object_Destruction_Piece(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CEdit_Map_Object_Destruction_Piece(const CEdit_Map_Object_Destruction_Piece& Prototype);
	virtual ~CEdit_Map_Object_Destruction_Piece() = default;
...
public:
	static CEdit_Map_Object_Destruction_Piece* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
