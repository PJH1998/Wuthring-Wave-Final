...
//NS_BEGIN(Editor)
//
//class CCustom_UI_Instance final : public CUIObject
//{
//public:
//	enum class UI_TYPE {
...
//	} Custom_UI_Instance_DESC;
//
//
//
//private:
//	explicit				CCustom_UI_Instance(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
//	explicit				CCustom_UI_Instance(const CCustom_UI_Instance& Prototype);
//	virtual					~CCustom_UI_Instance() = default;
//
//public:
...
//
//public:
//	Custom_UI_Instance_DESC			Get_UIDesc() { return m_tUIDesc; }
//	void					Set_UIDesc(Custom_UI_Instance_DESC tUIDesc) { m_tUIDesc = tUIDesc; }
...
//	CVIBuffer_Rect_Instance_UI* m_pVIBufferCom = { nullptr };
//	CTexture* m_pTextureCom = { nullptr };
//
//	CAnimator_UI* m_pAnimator_UICom = { nullptr };
//
//	Custom_UI_Instance_DESC			m_tUIDesc = {};
...
//
//public:
//	static CCustom_UI_Instance* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
...
//
//
//inline void to_json(json& j, const CCustom_UI_Instance::Custom_UI_Instance_DESC& d)
//{
...
//}
//
//inline void from_json(const json& j, CCustom_UI_Instance::Custom_UI_Instance_DESC& d)
//{
...
//}
//
//inline void to_json(json& j, const vector<CCustom_UI_Instance::Custom_UI_Instance_DESC>& vec)
//{
//	j = json::array();
...
//}
//
//inline void from_json(const json& j, vector<CCustom_UI_Instance::Custom_UI_Instance_DESC>& vec)
//{
//	vec.clear();
//	vec.reserve(j.size());
//
...
//	{
//		CCustom_UI_Instance::Custom_UI_Instance_DESC desc = {};
